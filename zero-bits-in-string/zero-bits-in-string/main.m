...
NSUInteger fastZeroBitsInString(const char *str) {
...
NSUInteger generalZeroBitsInString(const char *str) {
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        NSLog(@"Zero fast bits: %tu", fastZeroBitsInString([test cStringUsingEncoding:NSUTF8StringEncoding]));
        NSLog(@"Zero general bits: %tu", generalZeroBitsInString([test cStringUsingEncoding:NSUTF8StringEncoding]));
    }
    return 0;
}
